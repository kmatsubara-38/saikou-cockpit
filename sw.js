...
'use strict';
const CACHE = 'cp-shell-v44';   /* 2026-08-23 s44＝文体ラボ①失敗の原因を取り違えない（ok:falseの拒否を通信のせいにして古い控えを出来上がり欄に出す嘘を根治）②📚手本の複数欄をPC同格に（doPostにstyleTeachMultiの口が生えたため） */
 ...
 *   s44の変更は app.js と index.html（style.css は不変）。ASSETSは1つのキャッシュ名で丸ごと管理しているので版で入れ替える。
